...
CREATE TABLE `blog`.`po_001` (
  ...
  -- 文章分類階層一中文
  `po_001_cha1` VARCHAR(100) NOT NULL,
  -- 文字預留一
  `po_001_cha2` VARCHAR(100) NOT NULL,
  -- 文字預留二
  `po_001_cha3` VARCHAR(100) NOT NULL,
  -- 文字預留三
  `po_001_cha4` VARCHAR(100) NOT NULL,
  -- 文字預留四
  `po_001_cha5` VARCHAR(100) NOT NULL,
  -- 文字預留五
